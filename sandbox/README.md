...
<!--autoload_cluster=.-->
- [ ] `@user_001 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [princesa](user_001/README.md)
- [ ] `@user_002 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [linkedList](user_002/README.md)
- [ ] `@user_003 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [queimadaplus](user_003/README.md)

- [ ] `@user_004 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [pilhasfilas](user_004/README.md)
- [ ] `@user_005 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [labr2](user_005/README.md)
